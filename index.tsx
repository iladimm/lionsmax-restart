    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="relative bg-brand-50 md:rounded-2xl mt-4 mx-[-1rem] md:mx-0 overflow-hidden">
        <div className="p-6 md:p-10 flex flex-col items-start gap-4 relative z-10">
          ...
          <p className="text-xl text-brand-700 font-semibold italic mb-2">Restart Your Inner Lion</p>
...
import { HomeView as NewHomeView } from './src/components/home/HomeView';
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-800">
      ...
      <main className="flex-grow w-full">
        ...
        {/* Legacy Views (kept for now until refactored) */}
        {view === 'shop' && (
          <div className="max-w-[1440px] mx-auto px-4 py-8">
            <ShopView onViewProduct={viewProduct} />
          </div>
        )}
        {view === 'product' && selectedProduct && (
          <div className="max-w-[1440px] mx-auto px-4 py-8">
            <ProductDetailView product={selectedProduct} onBack={goShop} />
          </div>
        )}
        {view === 'blog' && (
          <div className="max-w-[1440px] mx-auto px-4 py-8">
            <BlogView onViewArticle={viewArticle} />
          </div>
        )}
        {view === 'article' && selectedBlogPost && (
          <div className="max-w-[1440px] mx-auto px-4 py-8">
            <ArticleView post={selectedBlogPost} onBack={goBlog} />
          </div>
        )}
        {view === 'assistant' && (
          <div className="max-w-[1440px] mx-auto px-4 py-8">
